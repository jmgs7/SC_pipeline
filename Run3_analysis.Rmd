...
SingleR.annotation <- SingleR(test = run3.SCexp, ref = reference, assay.type.test = "logcounts", labels = reference$label.main, num.threads = parallel::parallel::detectCores())
