...
# Intro: There is actually batch effect.
...
SCP_data <- RunPCA(SCP_data)

SCP_data <- IntegrateLayers(
  object = SCP_data, method = HarmonyIntegration,
  orig.reduction = "pca", new.reduction = "std.norm",
  verbose = FALSE
)
...
top <- head(VariableFeatures(SCP_data, assay = "SCT"), 20)

# plot variable features with and without labels
plot1 <- VariableFeaturePlot(SCP_data, assay = "SCT")
...
cluster18.markers <- FindMarkers(SCP_data, ident.1 = "T", ident.2 = "N", group.by = "Sample_Group", subset.ident = "18-Epithelial_cells", assay = "SCT")
```
