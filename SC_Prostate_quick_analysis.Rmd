...
```{r PCA, echo=FALSE, fig.height=6, fig.width=10}
...
```{r cluster_visualization, echo=FALSE, fig.height=6, fig.width=10}
...
```{r oneliner, echo=FALSE, fig.height=6, fig.width=10}
...
```{r PCA_Edu, echo=FALSE, fig.height=6, fig.width=10}
