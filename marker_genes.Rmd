...
Since recent discussion indicates that according to the use case sometimes is better to work on raw, non-integrated values (https://github.com/satijalab/seurat/discussions/5452?utm_source=pocket_saves) or log-transformed data, we only need to join the data layers, as there is no difference normalizing before or after the splitting (https://github.com/satijalab/seurat/issues/7585).
