...
# 3. Normalize and remove batch effect.
...
# 3.1. Normalize and apply data integration.
...
SCP_data <- ScaleData(SCP_data, assay = "RNA", vars.to.regress = c("percent.mt")) # regress out % mito.
...
SCP_data <- FindClusters(SCP_data, resolution = 1.1) # Default resolution = 0.8
...
saveRDS(SCP_data, file = "~/Documents/SC_Prostate/Data/SC_Prostate_std_norm.rds")
```
